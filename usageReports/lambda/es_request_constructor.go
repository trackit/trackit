...
// createQueryAccountFilterLambda creates and return a new *elastic.TermsQuery on the accountList array
func createQueryAccountFilterLambda(accountList []string) *elastic.TermsQuery {
