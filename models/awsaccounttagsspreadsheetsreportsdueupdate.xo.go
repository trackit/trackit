...
// AwsAccountTagsSpreadsheetsReportsDueUpdate represents a row from 'trackit.aws_account_tags_spreadsheets_reports_due_update'.
type AwsAccountTagsSpreadsheetsReportsDueUpdate struct {
	ID                                    int           `json:"id"`                                        // id
